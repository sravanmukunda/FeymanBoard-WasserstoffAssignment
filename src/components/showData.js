              ...
              <div className="showData">
                ...
                <div className="innerData">
                  {myData.data.map((item) => {
                    return (
                      <div key={newID++} className="showSpan">
                        <div className="showOptions">
                          ANY CALL ACTION : <br />
                          <button
                            onClick={() => handleCall("green")}
                            id="understood"
                          >
                            Understood
                          </button>
                          <button
                            onClick={() => handleCall("yellow")}
                            id="somewhat"
                          >
                            Somewhat Understood
                          </button>{" "}
                          <br />
                          <button
                            onClick={() => handleCall("orange")}
                            id="notclear"
                          >
                            NOT CLEAR
                          </button>
                          <button
                            onClick={() => handleCall("red")}
                            id="rubbish"
                          >
                            WHAT RUBBISH
                          </button>{" "}
                ...
                <div>
                  <h3>Percent Completion : {myData.completed} %</h3>
                </div>
              </div>
            ) : (
              <h1>NO DATA FOUND</h1>
